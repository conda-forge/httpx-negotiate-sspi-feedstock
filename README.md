About httpx-negotiate-sspi-feedstock
====================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/httpx-negotiate-sspi-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/httpx-negotiate-sspi-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add httpx-negotiate-sspi
# for installing globally
pixi global install httpx-negotiate-sspi
```
...
It is possible to list all of the versions of `httpx-negotiate-sspi` available on your platform:
...
```
pixi search httpx-negotiate-sspi --channel conda-forge
```
